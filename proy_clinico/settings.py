...
# PayPal credentials (usa variables de entorno para mayor seguridad)
PAYPAL_CLIENT_ID = config('PAYPAL_CLIENT_ID', default='ARC176RU_02YfD-NA_uHAYXpXjo0si03zsegvrJIiKQd9A24axcY5Ml0V1ywB6uqqnaVHTDBPVHLln6d')
PAYPAL_CLIENT_SECRET = config('PAYPAL_CLIENT_SECRET', default='EIJw7l9-51vtTj3jP36DJL925JkWnbXGf3juKaBRgnZRURAw1RPaaWgBkGS_KGK9Fhdf6LDpuvDiAZn_')
